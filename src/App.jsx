...
// --- Static Font Definition (REMOVED) ---
// We now control fonts with Tailwind (tailwind.config.js and index.html)
  ...
  return (
    ...
    >
      ...
      <div className="w-full flex items-center justify-center z-10">
        {/* THIS IS THE FIX! 
          Changed 'Mini_malistClock' back to 'MinimalistClock'
        */}
...
export default function App() {
  ...
  }, [mode, isRunning]); // Added isRunning to deps for togglePlay
